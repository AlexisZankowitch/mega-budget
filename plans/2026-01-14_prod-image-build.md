...
## Approach
- Add a minimal multi-stage Dockerfile for the spendtrack app.
...
2) Build and push `registry.lan:5000/spendtrack:prod-2026-01-14` from repo root.
...
## Verification
- `docker build -t registry.lan:5000/spendtrack:prod-2026-01-14 .`
- `docker push registry.lan:5000/spendtrack:prod-2026-01-14`
